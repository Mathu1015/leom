...
async def process_file(file_, user_id, dirpath=None, is_mirror=False):
    ...
    file_ = re_sub(r"^www\S+\s*[-_]*\s*", "SUNNXT:SNXT:1|- Telly|DDH|Tam +:Tamil\s:1|Tam]:Tamil]|Hin]: Hindi]|Tel +:Telugu\s:1|Hin +:Hindi\s:1|Mal +:Malayalam\s:1|Kan +:Kannada\s:1|Kor]:Korean]\s:1|Eng +: English|Jap]: Japanese]|Esubs|Eng]:English]|_White_|- ESub|@World4kMovie - |- Leyon|ENG: English| Esub|-XtRoN|XtRoN|.AMZN.WEB-DL.Multi.Audio.DDP.5.1.: AMZN WEB-DL [Tamil + Telugu + Hindi + Mandarin (DD+2.0 - 224kbps)] |.JIOHS.WEB-DL.Multi.Audio.DDP.5.1: DSNP WEB-DL [Tamil + Telugu + Hindi + English (DD+ 5.1 - 192kbps)] |.H265:×265|.H264:×264|RJTV: RAJTV|_Esub_|.JIOHS.: DSNP |ANToNi|.MX.WEB-DL.Multi.Audio.AAC.2.0: MX WEB-DL [Tamil + Telugu + Hindi (AAC 2.0 - 127kbps)] |.Multi.Audio.AAC.2.0: [Tamil + Telugu + Hindi + English (AAC 2.0 - 128kbps)] |.Tamil.AAC.2.0.: [Tamil (AAC 2.0 - 128kbps)] | .Tamil.DDP.5.1.: Tamil (DD+5.1 - 192kbps)] |", file_)
    if remname:
